...
const features = [
  ...
  { icon: <Globe size={24} />, label: 'Smart Connectivity', value: '2.4 GHz Wi-Fi with Android companion app support.' },
...
const FeaturesSection = () => (
  <section className="section" id="features">
    <div className="container">
      <div className="glass-card" style={{ padding: 'clamp(40px, 6vw, 80px) clamp(20px, 4vw, 40px)' }}>
